...
def make_model(src_vocab, tgt_vocab, N=6,
               d_model=512, d_ff=2048, h=16, dropout=0.2):
...
class Batch:
    ...
    def __init__(self, src, trg=None,no_pad=None,pad=0):
        #print(src.shape,trg.shape,sep='&&')
        self.src = src.cuda()
        ...
        if trg is not None:
            ...
            #print(self.trg.shape,self.src.shape,self.trg_mask.shape,self.trg_y.shape,self.ntokens,sep='$$')
...
def run_epoch(data_iter, model, loss_compute):
    ...
    for i, batch in enumerate(data_iter):
        ...
        if i % 50 == 1:
            ...
            if batch.ntokens.item()!=0 and elapsed!=0:
